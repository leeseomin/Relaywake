...
export const enemies = z.array(EnemyDefinitionSchema).parse([
  ...
  },
  {
    ...
    hp: 33, damage: 5, speed: 49, xp: 2, radius: 19, attackRange: 30, attackCooldown: 0.82,
  ...
  },
  {
    ...
    hp: 55, damage: 10, speed: 45, xp: 10, radius: 22, attackRange: 34, attackCooldown: 1.02,
  ...
  },
  {
    ...
    hp: 27.5, damage: 4, speed: 61, xp: 4, radius: 19, attackRange: 230, attackCooldown: 2,
  ...
  },
  {
    ...
    hp: 49.5, damage: 5, speed: 50, xp: 7, radius: 20, attackRange: 275, attackCooldown: 3.15,
  ...
  },
  {
    ...
    hp: 41.8, damage: 10, speed: 39, xp: 9, radius: 21, attackRange: 310, attackCooldown: 3.35,
