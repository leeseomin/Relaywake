import { z } from 'zod';
import { AbilityIdSchema } from '../game/data/schemas';

export const ProfileSchema = z.object({
  id: z.literal('main'),
  coins: z.number().int().nonnegative(),
  unlockedCharacters: z.array(z.enum(['blue', 'purple', 'white', 'gray'])),
...
export const RunRowSchema = z.object({
  id: z.string(),
  characterId: z.enum(['blue', 'purple', 'white', 'gray']),
  victory: z.boolean(),
...
export const defaultProfile = (): Profile => ProfileSchema.parse({
  id: 'main',
  coins: 0,
  unlockedCharacters: ['blue', 'purple', 'white', 'gray'],
  bestTimeSeconds: 0,
  bestKills: 0,
  totalRuns: 0,
  discoveredAbilities: [],
